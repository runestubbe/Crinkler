...
#define CRINKLER_IMAGEBASE 0x400000
#define CRINKLER_SECTIONSIZE 0x10000
#define CRINKLER_SECTIONBASE (CRINKLER_IMAGEBASE+CRINKLER_SECTIONSIZE)
#define CRINKLER_CODEBASE (CRINKLER_IMAGEBASE+2*CRINKLER_SECTIONSIZE)
