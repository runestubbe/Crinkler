...
#define CRINKLER_TITLE "Crinkler 1.3 (" __DATE__ ") (c) 2005-2011 Aske Simon Christensen & Rune Stubbe"
#define CRINKLER_WITH_VERSION "Crinkler 1.3"
const int CRINKLER_LINKER_VERSION = 0x3331;
