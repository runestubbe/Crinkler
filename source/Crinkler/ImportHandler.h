...
public:
	...
	static void AddImportHunks4K(Part& part, Hunk*& hashHunk, Hunk* header, Hunk* headerRefHunk, const std::string& rangeDll, bool verbose, bool& usesRangeImport, int& dllSkip);
};
