...
/* diStorm64 Version */
#define __DISTORMV__ 0x010718

/*
 * Comment out this macro if you wish to use 32 bits offsets only!
 * Or because your compiler doesn't support 64 bit integers...
 */
...
/////////////////////////////////// */
_DecodeResult distorm_decode(_OffsetType codeOffset, const unsigned char* code, int codeLen, _DecodeType dt, _DecodedInst result[], unsigned int maxInstructions, unsigned int* usedInstructionsCount);
